...
module Game_DB
  ...
  def populate_weapons_db
    ...
    @weapons[3] = ["Mage-Staff   ",            3,  12,  true,     75]
    @weapons[4] = ["Wooden Club  ",            6,   5, false,     75]
    @weapons[5] = ["Iron Hatchet ",            11,  5, false,    120]
    @weapons[6] = ["Iron Lance   ",            36,  2,  true,    250]
    @weapons[7] = ["Iron Sword   ",            32,  4, false,    550]
    @weapons[8] = ["Sage-Staff   ",            20, 15,  true,   1040]
  ...
  def populate_armor_db
    ...
    @armors[2]=  ["Mage's Robe  ",             4,   8,           80]
    @armors[3] = ["Leather Armor",            12,   4,           90]
    @armors[4] = ["Chainmail    ",            28,   5,          550]
    @armors[5]=  ["Magikal Robe ",            25,  13,         1300]
  ...
  def populate_spells_db
    ...
    @spells[1] = ["Heal",                  true,    [8, 35],    4,   "Simple healing spell"]
    @spells[2] = ["Greater Heal",          true,  [48, 160],   11,   "Less simple healing spell"]
    ...
    @spells[6] = ["Shock",                false,   [18, 36],    8,   "Electricity shoots from your mouth and strikes"]
